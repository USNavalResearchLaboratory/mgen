...
const char ns2_node_movement_pr_cpp [] = "MIL_3_Tfile_Hdr_ 120A 30A modeler 7 450ECBCB 450ECBCB 1 apocalypse Jim@Hauser 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 fec 0                                                                                                                                                                                                                                                                                                                                                                                                     ";
#include <string.h>
...
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((ns2_node_movement_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
extern "C"
{
	...
	VosT_Address _op_ns2_node_movement_alloc (VosT_Obtype, int);
	void ns2_node_movement (OP_SIM_CONTEXT_ARG_OPT)
		{
...
ns2_node_movement_state::operator new (size_t)
	...
	new_ptr = Vos_Alloc_Object (ns2_node_movement_state::obtype);
#if defined (VOSD_NEW_BAD_ALLOC)
...
VosT_Address
_op_ns2_node_movement_alloc (VosT_Obtype, int)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
